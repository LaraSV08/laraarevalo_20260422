...
const sanSalvador = [30,32,34,35,36,37,36,35,34,32,31,30]; //TEMPERATURAS REGISTADAS EN SAN SALVADOR POR MES
const santaTecla = [25,26,28,29,31,32,32,31,30,28,27,26];   //TEMPERATURAS REGISTADAS EN SANTa TECLA POR MES
